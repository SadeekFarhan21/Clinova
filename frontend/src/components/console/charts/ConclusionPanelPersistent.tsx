...
interface ConclusionPanelPersistentProps {
  drugName: string;
  data: {
    riskDiff: string;
    ciLow: string;
...
export const ConclusionPanelPersistent = ({ drugName, data }: ConclusionPanelPersistentProps) => {
  const { riskDiff, ciLow, ciHigh, pValue, isSignificant, favorsDrug } = data;
