...
import { TypewriterText } from "@/components/canvas/TypewriterText";
import researchData from "@/data/research-questions.json";

interface ResearchCandidateSelectorProps {
...
export const ResearchCandidateSelector = ({ onSelect, onBack }: ResearchCandidateSelectorProps) => {
  ...
  }, [isThinking, randomQuestions.length]);
